...
vuelos_dt %>%
  ...
  geom_smooth()
```
Cómo podemos observar en el gráfico el retrado en la salida de los vuelos aumenta a medida que va pasando el día alcanzando su punto máximo aproximadamente entre las 6 y 8 de la tarde. Sin embargo, podemos apreciar como durante la madrugada los retrasos son menores.
